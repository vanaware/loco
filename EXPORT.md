...
Gerado automaticamente em: 8/6/2026, 7:39:47 PM
...
/* Toast (substituído por alert por enquanto) */
.toast {
  position: fixed;
  bottom: 24px;
  right: 24px;
