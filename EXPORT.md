> **INSTRUÇÃO PARA A IA:** 
> O texto abaixo contém múltiplos arquivos do projeto **Loco v0.2.33-msmo6cyz** (CÓDIGO FONTE) estruturados em blocos. 
> Cada arquivo começa com um título indicando seu caminho relativo exato (ex: `## Arquivo: src/main.ts`).
> Sempre que sugerir alterações, indique claramente qual arquivo deve ser modificado com base nesses caminhos e forneça o novo código completo do arquivo.

---

# Contexto Exportado do Projeto Loco [v0.2.33-msmo6cyz] - Modo: MAIN

Gerado automaticamente em: 8/10/2026, 12:26:39 AM
...
export const APP_VERSION = "0.2.33-msmo6cyz";
...
```json
{
  ...
  "tasks": {
    ...
    "worker": "deno task build && deno serve --allow-read --allow-write --allow-env --allow-net --env-file --watch worker.ts",
...
name = "@vanaware/loco"
   ...
   [vars]
   # Se preferir colocar chaves públicas não sensíveis aqui, ou use `wrangler secret put` para a privada
```
